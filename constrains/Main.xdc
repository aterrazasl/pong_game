...
##Switches
#set_property -dict {PACKAGE_PIN G15 IOSTANDARD LVCMOS33} [get_ports { swd[0] }];
#set_property -dict {PACKAGE_PIN P15 IOSTANDARD LVCMOS33} [get_ports { swd[1] }];
#set_property -dict {PACKAGE_PIN W13 IOSTANDARD LVCMOS33} [get_ports { swd[2] }];
#set_property -dict {PACKAGE_PIN T16 IOSTANDARD LVCMOS33} [get_ports { swd[3] }];
...
#VGA
set_property -dict { PACKAGE_PIN P19   IOSTANDARD LVCMOS33 } [get_ports {VGAports[h_sync]}];
set_property -dict { PACKAGE_PIN R19   IOSTANDARD LVCMOS33 } [get_ports {VGAports[v_sync]}];
set_property -dict { PACKAGE_PIN M19   IOSTANDARD LVCMOS33 } [get_ports {VGAports[red][0]}];
set_property -dict { PACKAGE_PIN L20   IOSTANDARD LVCMOS33 } [get_ports {VGAports[red][1]}];
set_property -dict { PACKAGE_PIN J20   IOSTANDARD LVCMOS33 } [get_ports {VGAports[red][2]}];
set_property -dict { PACKAGE_PIN G20   IOSTANDARD LVCMOS33 } [get_ports {VGAports[red][3]}];
set_property -dict { PACKAGE_PIN F19   IOSTANDARD LVCMOS33 } [get_ports {VGAports[red][4]}];
set_property -dict { PACKAGE_PIN H18   IOSTANDARD LVCMOS33 } [get_ports {VGAports[green][0]}];
set_property -dict { PACKAGE_PIN N20   IOSTANDARD LVCMOS33 } [get_ports {VGAports[green][1]}];
set_property -dict { PACKAGE_PIN L19   IOSTANDARD LVCMOS33 } [get_ports {VGAports[green][2]}];
set_property -dict { PACKAGE_PIN J19   IOSTANDARD LVCMOS33 } [get_ports {VGAports[green][3]}];
set_property -dict { PACKAGE_PIN H20   IOSTANDARD LVCMOS33 } [get_ports {VGAports[green][4]}];
set_property -dict { PACKAGE_PIN F20   IOSTANDARD LVCMOS33 } [get_ports {VGAports[green][5]}];
set_property -dict { PACKAGE_PIN P20   IOSTANDARD LVCMOS33 } [get_ports {VGAports[blue][0]}];
set_property -dict { PACKAGE_PIN M20   IOSTANDARD LVCMOS33 } [get_ports {VGAports[blue][1]}];
set_property -dict { PACKAGE_PIN K19   IOSTANDARD LVCMOS33 } [get_ports {VGAports[blue][2]}];
set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports {VGAports[blue][3]}];
set_property -dict { PACKAGE_PIN G19   IOSTANDARD LVCMOS33 } [get_ports {VGAports[blue][4]}];
